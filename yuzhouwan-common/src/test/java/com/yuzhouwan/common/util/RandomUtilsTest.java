...
public class RandomUtilsTest {
    ...
    public void getGaussianTest() {
        ...
        LOGGER.info("Param: {}/{}/{}, Total: {}", 0, 15, 15, total);
        LOGGER.info(JSON.toJSONString(gaussian));
        ...
        total = 0;
        for (Integer g : gaussian) total += g;
        LOGGER.info("Param: {}/{}/{}, Total: {}", 0, 9, 9, total);
        LOGGER.info(JSON.toJSONString(gaussian));
        ...
        total = 0;
        for (Integer g : gaussian) total += g;
        LOGGER.info("Param: {}/{}/{}, Total: {}", 0, 15, 71, total);
        LOGGER.info(JSON.toJSONString(gaussian));
        ...
        total = 0;
        for (Integer g : gaussian) total += g;
        LOGGER.info("Param: {}/{}/{}, Size: {}, Total: {}", 0, 15, 9, gaussian.size(), total);
        LOGGER.info(JSON.toJSONString(gaussian));
        ...
        total = 0;
        for (Integer g : gaussian) total += g;
        LOGGER.info("Param: {}/{}/{}, Size: {}, Total: {}", 0, 15, 71, gaussian.size(), total);
        LOGGER.info(JSON.toJSONString(gaussian));
    ...
    public void testUUID() {
        ...
        LOGGER.info("Count: {}, Time: {} ms", count, time / Math.pow(10, 6));
    }
