...
public class SnmpUtil extends Thread implements PDUFactory, CommandResponder {
    ...
    private final OctetString _community = new OctetString("public");
    ...
    private final boolean _isReceiver;
    private final OctetString _authoritativeEngineID = new OctetString("1234567");
    private TransportMapping _transport = null;
    private final TimeTicks _sysUpTime = new TimeTicks(0);
    private final OID _trapOID = new OID("1.3.6.1.4.1.2789.2005");
    private int version;
