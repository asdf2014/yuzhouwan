...
public class SpringAOPWithAspectJ {
    ...
    @Before("execution(* com.yuzhouwan.site.hacker.aop.TargetAOP.targetBefore(..))")
    public void beforeTarget(JoinPoint joinPoint) {

        showClassMethod(joinPoint);
    }

    @After("execution(* com.yuzhouwan.site.hacker.aop.TargetAOP.targetAfter(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.yuzhouwan.site.hacker.aop.TargetAOP.targetAfterReturning(..))",
            returning = "_return")
    ...
    @Around("execution(* com.yuzhouwan.site.hacker.aop.TargetAOP.targetAround(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* com.yuzhouwan.site.hacker.aop.TargetAOP.targetAfterThrowing(..))",
            throwing = "error")
