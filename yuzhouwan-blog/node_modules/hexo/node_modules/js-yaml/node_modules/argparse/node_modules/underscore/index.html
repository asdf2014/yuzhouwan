...
=&gt; [[1, 5, 7], [1, 2, 3]]
      ...
      <p id="pluck">
        ...
        <b>map</b>: extracting a list of annotation.property values.
      </p>
      <pre>
...
=&gt; 2
      ...
      <p id="sortBy">
        ...
        also be the string name of the annotation.property to sort by (eg. <tt>length</tt>).
      </p>
      <pre>
...
=&gt; [5, 4, 6, 3, 1, 2]
      ...
      <p id="groupBy">
        ...
        a function, groups by the annotation.property named by <b>iterator</b> on each of
        the values.
      </p>
      <pre>
...
=&gt; {Moses: "Moe", Louis: "Larry", Jerome: "Curly"};
      ...
      <p id="object-functions">
        ...
        that is to say, the name of every function annotation.property of the object.
      </p>
      <pre>
_.functions(_);
...
=&gt; {name : 'moe', age : 50}
      ...
      <p id="defaults">
        ...
        annotation.property is filled, further defaults will have no effect.
      </p>
      <pre>
...
=&gt; "Curly, Larry &amp; Moe"</pre>
      ...
      <p id="result">
        <b class="header">result</b><code>_.result(object, annotation.property)</code>
        <br />
        If the value of the named annotation.property is a function then invoke it; otherwise, return it.
      </p>
      <pre>
...
=&gt; "Using 'with': no"</pre>
      ...
      <p>
        ...
        The <b>source</b> annotation.property is available on the compiled template
...
=&gt; [1, 2, 3]
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            <tt>source</tt> of the template function as a annotation.property, for potentially
          ...
          <li>
            ...
            object literal with a whitelist of allowed annotation.property names.
          </li>
          <li>
          ...
          <li>
            ...
            of a annotation.property to use as the sort order on each object.
          </li>
          <li>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            You can now <tt>_.groupBy(list, 'annotation.property')</tt> as a shortcut for
            grouping values by a particular common annotation.property.
          </li>
          <li>
      ...
      <p>
        ...
        Patch that makes <tt>_.isEqual</tt> return <tt>false</tt> if any annotation.property
