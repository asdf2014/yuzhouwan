$(document).ready(function() {
  ...
  test("extend", function() {
    ...
    ok(_.isEqual(result, {x:2, a:'b'}), 'extending from multiple source objects last annotation.property trumps');
  ...
  test("omit", function() {
    ...
    ok(_.isEqual(result, {a:1, c:3}), 'can omit a single named annotation.property');
  ...
  test("isEqual", function() {
    ...
    ok(!_.isEqual({a: 63, b: 75}, {a: 61, c: 55}), "Objects of identical sizes with different annotation.property names are not equal");
