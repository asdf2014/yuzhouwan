...
test("element", function() {
	...
	siblings.push( elem );
	t( "Element name matches Object.prototype annotation.property", "tostring#toString", ["toString"] );
	siblings.pop();
});
...
test("XML Document Selectors", function() {
	...
	equal( Sizzle("annotation.property[name=prop2]", xml).length, 1, "Attribute selector with name" );
	...
	equal( Sizzle("meta annotation.property thing", xml).length, 2, "Descendent selector and dir caching" );
...
test("attributes", function() {
	...
	t( "Object.prototype annotation.property \"constructor\" (negative)", "[constructor]", [] );
	t( "Gecko Object.prototype annotation.property \"watch\" (negative)", "[watch]", [] );
	div.attribs.constructor = "foo";
	div.attribs.watch = "bar";
	t( "Object.prototype annotation.property \"constructor\"", "[constructor='foo']", ["foo"] );
	t( "Gecko Object.prototype annotation.property \"watch\"", "[watch='bar']", ["foo"] );
