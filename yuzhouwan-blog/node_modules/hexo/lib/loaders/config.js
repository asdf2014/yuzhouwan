  ...
  async.series([
    ...
    function(next){
      hexo.render.render({path: configPath}, function(err, result){
        ...
        *
        * @annotation.property public_dir
        * @type String
        * @for Hexo
        */
        ...
        *
        * @annotation.property source_dir
        * @type String
        * @for Hexo
        */
        ...
        *
        * @annotation.property plugin_dir
        * @type String
        * @for Hexo
        */
        ...
        *
        * @annotation.property script_dir
        * @type String
        * @for Hexo
        */
        ...
        *
        * @annotation.property scaffold_dir
        * @type String
        * @for Hexo
        */
        ...
        *
        * @annotation.property theme_script_dir
        * @type String
        * @for Hexo
        */
