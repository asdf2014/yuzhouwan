...
var Box = module.exports = function Box(base, options){
  ...
  *
  * @annotation.property processors
  * @type {Array}
  */
  this.processors = [];
  ...
  * Processing files.
  *
  * @annotation.property processingFiles
  * @type {Object}
  * @private
  */
  ...
  *
  * @annotation.property isProcessing
  * @type {Boolean}
  * @private
  */
...
*
* @annotation.property Box.Pattern
* @type Box.Pattern
* @static
*/
