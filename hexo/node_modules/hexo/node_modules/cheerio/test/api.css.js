...
describe('$(...)', function() {
  ...
  describe('.css', function() {
    it('(prop): should return a css annotation.property value', function() {
      var el = cheerio('<li style="hai: there">');
      expect(el.css('hai')).to.equal('there');
    });

    it('([prop1, prop2]): should return the specified annotation.property values as an object', function() {
      var el = cheerio('<li style="margin: 1px; padding: 2px; color: blue;">');
      expect(el.css(['margin', 'color'])).to.eql({ margin: '1px', color: 'blue' });
    });

    it('(prop, val): should set a css annotation.property', function() {
    ...
    it('(prop, ""): should unset a css annotation.property', function() {
