...
Parser.prototype = {
  ...
  looksLikeSelector: function() {
    ...
    while (this.isSelectorToken(i)
      ...
      // for example "foo{bar}{baz}" may be a annotation.property,
      ...
      // as 'td:th-child(1)' may look like a annotation.property
  ...
  scope: function(){
    this.expect('scope');
    var selector = this.selectorParts()[0];
    this.selectorScope = selector.val.trim();
    return nodes.null;
  },
    ...
    switch (la) {
      ...
      case 'is defined':
        ...
        if (this._ident == this.peek()) {
          ...
          this._ident = this.peek();
          switch (this.currentState()) {
            // unary op or selector in annotation.property / for
            case 'for':
            case 'selector':
              return this.property();
            // Part of a selector
      ...
      // Selector or annotation.property
      default:
        switch (this.currentState()) {
          case 'root':
            return this.selector();
  ...
  /**
   *   annotation.property ':'? expression
   * | ident
   */
