...
exports.adjust = function adjust(color, prop, amount){
  ...
  if (!prop) throw new Error('invalid adjustment annotation.property');
  var val = amount.val;
  if ('%' == amount.type){
    val = 'l' == prop && val > 0
...
/**
 * Add annotation.property `name` with the given `expr`
...
(exports['add-annotation.property'] = function addProperty(name, expr){
